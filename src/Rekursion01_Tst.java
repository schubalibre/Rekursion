...
class Rekursion01_Tst {
	...
	static final void tst_fiboR(final int N, final int SOLL) {
		...
		printf("fiboR      (%2d), IST: %,13d, SOLL: %,13d %s%n", N, IST, SOLL,
				text);
	}
	...
	static final void tst_anzWeisen12(final int N, final int SOLL) {
		...
		printf("anzWeisen12(%2d), IST: %,13d, SOLL: %,13d %s%n", N, IST, SOLL,
				text);
	}
	...
	static final void tst_anzWeisen13(final int N, final int SOLL) {
		...
		printf("anzWeisen13(%2d), IST: %,13d, SOLL: %,13d %s%n", N, IST, SOLL,
				text);
	}
 ...
 * -------------------------------------------------------- fiboR ( 0), IST: 0,
 * SOLL: 0 <--- OK fiboR ( 1), IST: 1, SOLL: 1 <--- OK fiboR ( 2), IST: 1, SOLL:
 * 1 <--- OK fiboR ( 3), IST: 2, SOLL: 2 <--- OK fiboR ( 4), IST: 3, SOLL: 3
 * <--- OK fiboR ( 5), IST: 5, SOLL: 5 <--- OK fiboR ( 6), IST: 8, SOLL: 8 <---
 * OK fiboR ( 7), IST: 13, SOLL: 13 <--- OK fiboR ( 8), IST: 21, SOLL: 21 <---
 * OK fiboR (10), IST: 55, SOLL: 55 <--- OK fiboR (20), IST: 6.765, SOLL: 6.765
 * <--- OK fiboR (30), IST: 832.040, SOLL: 832.040 <--- OK fiboR (40), IST:
 * 102.334.155, SOLL: 102.334.155 <--- OK fiboR (45), IST: 1.134.903.170, SOLL:
 * 1.134.903.170 <--- OK
 * -------------------------------------------------------- anzWeisen12( 1),
 * IST: 1, SOLL: 1 <--- OK anzWeisen12( 2), IST: 2, SOLL: 2 <--- OK anzWeisen12(
 * 3), IST: 3, SOLL: 3 <--- OK anzWeisen12( 4), IST: 5, SOLL: 5 <--- OK
 * anzWeisen12( 5), IST: 8, SOLL: 8 <--- OK anzWeisen12( 6), IST: 13, SOLL: 13
 * <--- OK anzWeisen12( 7), IST: 21, SOLL: 21 <--- OK anzWeisen12( 8), IST: 34,
 * SOLL: 34 <--- OK anzWeisen12( 9), IST: 55, SOLL: 55 <--- OK anzWeisen12(19),
 * IST: 6.765, SOLL: 6.765 <--- OK anzWeisen12(29), IST: 832.040, SOLL: 832.040
 * <--- OK anzWeisen12(39), IST: 102.334.155, SOLL: 102.334.155 <--- OK
 * anzWeisen12(44), IST: 1.134.903.170, SOLL: 1.134.903.170 <--- OK
 * -------------------------------------------------------- anzWeisen13( 1),
 * IST: 1, SOLL: 1 <--- OK anzWeisen13( 2), IST: 2, SOLL: 2 <--- OK anzWeisen13(
 * 3), IST: 4, SOLL: 4 <--- OK anzWeisen13( 4), IST: 7, SOLL: 7 <--- OK
 * anzWeisen13( 5), IST: 13, SOLL: 13 <--- OK anzWeisen13( 6), IST: 24, SOLL: 24
 * <--- OK anzWeisen13( 7), IST: 44, SOLL: 44 <--- OK anzWeisen13( 8), IST: 81,
 * SOLL: 81 <--- OK anzWeisen13( 9), IST: 149, SOLL: 149 <--- OK
 * anzWeisen13(20), IST: 121.415, SOLL: 121.415 <--- OK anzWeisen13(30), IST:
 * 53.798.080, SOLL: 53.798.080 <--- OK
 * -------------------------------------------------------- Anzahl Fehler: 0
 * -------------------------------------------------------- Rekursion01_Tst: Das
 * war's erstmal!
 * ------------------------------------------------------------------------
